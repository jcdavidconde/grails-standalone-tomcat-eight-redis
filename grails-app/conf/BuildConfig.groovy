...
grails.project.dependency.resolution = {
    ...
    repositories {
		...
		mavenRepo "http://dl.bintray.com/codefinger/maven"
    }
    dependencies {
        // specify dependencies here under either 'build', 'compile', 'runtime', 'test' or 'provided' scopes eg.
        // runtime 'mysql:mysql-connector-java:5.1.27'
		
		compile 'com.github.jkutner:tomcat-redis-session:8.0.18.0', {
			excludes 'commons-pool', 'tomcat-catalina', 'tomcat-jasper', 'tomcat-servlet-api'
		}
